...
export const AboutAndArchitecture: React.FC = () => {
  ...
  return (
    <section id="about" className="relative py-20 sm:py-24 border-b border-[#1A2540]/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="p-6 rounded-xl bg-[#0C1220] border border-[#1A2540] backdrop-blur-md shadow-[0_4px_24px_rgba(0,0,0,0.4)]">
              <h3 className="text-base font-mono font-semibold text-blue-400 mb-3 flex items-center gap-2">
              ...
              <p className="text-sm text-slate-400 leading-relaxed mb-4 font-sans">
                ...
                the same: <strong className="text-white font-semibold">predictable latency, zero data loss, and ironclad observability</strong>.
              </p>
            ...
            <div className="space-y-4">
              {/* Education */}
              <div className="p-5 rounded-xl bg-[#0C1220]/60 border border-[#1A2540] shadow-[0_4px_20px_rgba(0,0,0,0.3)]">
                <div className="flex items-start gap-3.5">
                  <div className="p-2.5 rounded-lg bg-[#060A12] border border-blue-900/60 text-blue-400">
                    <GraduationCap className="w-4 h-4" />
                  </div>
                  <div>
                    <span className="font-mono text-[10px] text-slate-500 uppercase tracking-wider block font-medium">Education</span>
                    <h4 className="text-sm font-bold font-heading text-white mt-0.5">
              ...
              <div className="p-5 rounded-xl bg-[#0C1220]/60 border border-[#1A2540] shadow-[0_4px_20px_rgba(0,0,0,0.3)]">
                <div className="flex items-start gap-3.5">
                  <div className="p-2.5 rounded-lg bg-[#060A12] border border-indigo-900/60 text-indigo-400">
                    <Award className="w-4 h-4" />
                  </div>
                  <div>
                    <span className="font-mono text-[10px] text-slate-500 uppercase tracking-wider block font-medium">Verified Certification</span>
                    <h4 className="text-sm font-bold font-heading text-white mt-0.5">
                      {PROFILE.certifications[0].name}
                    </h4>
                    <p className="text-xs text-indigo-400 font-mono font-medium mt-0.5">
          ...
          {/* Interactive Architecture Stack Column */}
          <div className="lg:col-span-7 space-y-6">
            <div className="p-5 sm:p-6 rounded-xl bg-[#0C1220] border border-[#1A2540] backdrop-blur-md shadow-[0_4px_24px_rgba(0,0,0,0.4)]">
                    ...
                    <div
                      ...
                      className={`cursor-pointer p-3.5 sm:p-4 rounded-lg border transition-all duration-300 font-mono ${
                        isActive
                          ...
                          : 'border-[#1A2540] bg-[#060A12]/60 hover:bg-[#0C1220]/80 text-slate-500'
                      }`}
                    >
              ...
              {/* Layer Inspector */}
              <div className="p-4 sm:p-5 rounded-lg bg-[#060A12] border border-[#1A2540] mt-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-3 border-b border-[#1A2540]/60 pb-2.5 gap-2">
                  ...
                  <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-blue-950/40 text-blue-400 border border-blue-800/50 font-semibold self-start sm:self-auto">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {selectedLayerData.technologies.map((tech) => (
                        <span
                          key={tech}
                          className="px-2 py-0.5 rounded text-[11px] font-mono bg-[#0C1220] border border-[#1A2540] text-slate-300 font-medium"
                        >
                          {tech}
                        </span>
                      ))}
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {selectedLayerData.protocols.map((proto) => (
                        <span
                          key={proto}
                          className="px-2 py-0.5 rounded text-[11px] font-mono bg-[#0C1220] border border-[#1A2540] text-blue-400 font-medium"
                        >
                          {proto}
                        </span>
                      ))}
